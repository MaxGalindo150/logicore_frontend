...
import { operatorNavData } from './nav-config';

import { useAuthContext } from 'src/auth/hooks';

// ----------------------------------------------------------------------

export function OperatorLayout({ sx, children, data }) {
  ...
  const navData = data?.nav ?? operatorNavData;
        ...
        headerSection={
          <HeaderBase
            ...
            data={{
              nav: navData,
              langs: [
                { value: 'es', label: 'Español', countryCode: 'MX' },
