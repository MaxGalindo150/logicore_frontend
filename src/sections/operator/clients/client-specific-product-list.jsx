...
import { ClientProductTableRow } from './client-product-table-row';
import { ProductTableToolbar } from '../products/product-table-toolbar';
import { ProductTableFiltersResult } from '../products/product-table-filters-result';
...
export function ClientSpecificProductList({ clientFilter }) {
  ...
  const allProducts = useMemo(
    () => _productsList.filter(product => product.clientId === clientFilter),
    [clientFilter]
  );
